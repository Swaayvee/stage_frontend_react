...
export function getStatusColor(status) {
  ...
  if (
    ...
    return "green";
  if (s.includes("soumise") || s.includes("à attribuer")) return "amber";
  if (s.includes("retirée") || s.includes("retiree")) return "blue";
  if (s.includes("échouée") || s.includes("echouee")) return "red";
  if (
