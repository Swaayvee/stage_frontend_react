...
export function createSeedState() {
  ...
  const vendeurs = [
    {
      ...
      adresse: "14 Rue Sala",
      coordonnees: { lat: 45.7545, lng: 4.8322 },
      ville: "Lyon",
      departement: "Rhône",
      dateCreation: iso(new Date("2025-01-14")),
    },
    {
      ...
      coordonnees: { lat: 45.7602, lng: 4.8501 },
      ville: "Lyon",
      departement: "Rhône",
      dateCreation: iso(new Date("2025-03-03")),
    },
  ...
  const livreurs = [
    {
      ...
      partagePositionActif: true,
      positionActualiseeLe: iso(now),
    },
    {
      _id: "liv2",
  ...
  const livraisons = [
    ...
    },
    {
      ...
      villeLivraison: "Lyon",
      coordonneesLivraison: { lat: 45.7578, lng: 4.8268 },
      departementLivraison: "Rhône",
      descriptionContenu: "Commande boutique",
      statut: "SOUMISE",
